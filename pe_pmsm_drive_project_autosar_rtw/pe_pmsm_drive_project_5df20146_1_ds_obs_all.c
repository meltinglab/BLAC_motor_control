...
sint32 pe_pmsm_drive_project_5df20146_1_ds_obs_all(const NeDynamicSystem *sys,
  const NeDynamicSystemInput *t47, NeDsMethodOutput *t48)
{
  ...
  t0[111ULL] = t29;
  t0[112ULL] = -(X_idx_8 * t29 * 0.001) / -1.0 * 1000.0;
  t0[113ULL] = X_idx_16;
  t0[114ULL] = 0.0;
  t0[115ULL] = U_idx_2;
  t0[116ULL] = t30;
  ...
  t0[125ULL] = X_idx_16;
  t0[126ULL] = X_idx_16;
  t0[127ULL] = -(X_idx_16 * X_idx_20 * 0.001) / -1.0 * 1000.0;
  ...
  t0[141ULL] = t33;
  t0[142ULL] = -(X_idx_10 * t33 * 0.001) / -1.0 * 1000.0;
  t0[143ULL] = X_idx_17;
  t0[144ULL] = 0.0;
  t0[145ULL] = U_idx_4;
  t0[146ULL] = t34;
  ...
  t0[155ULL] = X_idx_17;
  t0[156ULL] = X_idx_17;
  t0[157ULL] = -(X_idx_17 * X_idx_21 * 0.001) / -1.0 * 1000.0;
  ...
  t0[171ULL] = t37;
  t0[172ULL] = -(X_idx_12 * t37 * 0.001) / -1.0 * 1000.0;
  t0[173ULL] = X_idx_18;
  t0[174ULL] = 0.0;
  t0[175ULL] = U_idx_6;
  t0[176ULL] = t38;
  ...
  t0[185ULL] = X_idx_18;
  t0[186ULL] = X_idx_18;
  t0[187ULL] = -(X_idx_18 * X_idx_22 * 0.001) / -1.0 * 1000.0;
  t0[188ULL] = -t21;
  t0[189ULL] = X_idx_14;
  t0[190ULL] = X_idx_15;
  t0[191ULL] = X_idx_16;
