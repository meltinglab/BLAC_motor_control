...
sint32 pe_pmsm_drive_project_5df20146_1_ds_mode(const NeDynamicSystem *sys,
  const NeDynamicSystemInput *t7, NeDsMethodOutput *t8)
{
  ...
  out.mX[0] = (sint32)(Three_phase_inverter_IGBT_AH_ideal_switch_v - 0.8 <=
                        U_idx_1 - 0.5);
  out.mX[1] = (sint32)(X_idx_16 - 0.8 <= U_idx_2 - 0.5);
  out.mX[2] = (sint32)(((((((X_idx_7 * -0.001 + X_idx_8 * 0.001) + X_idx_9 *
    -0.001) + X_idx_10 * 0.001) + X_idx_11 * -0.001) + X_idx_12 * 0.001) +
    X_idx_17) + -110.0 > 0.8);
  out.mX[3] = (sint32)t0;
  out.mX[4] = (sint32)(-X_idx_17 > 0.8);
  out.mX[5] = (sint32)t1;
  out.mX[6] = (sint32)(((((((X_idx_7 * -0.001 + X_idx_8 * 0.001) + X_idx_9 *
    -0.001) + X_idx_10 * 0.001) + X_idx_11 * -0.001) + X_idx_12 * 0.001) +
    X_idx_18) + -110.0 > 0.8);
  out.mX[7] = (sint32)t2;
  out.mX[8] = (sint32)(-X_idx_18 > 0.8);
  out.mX[9] = (sint32)t3;
  out.mX[10] = (sint32)(Three_phase_inverter_IGBT_BH_ideal_switch_v - 0.8 <=
    U_idx_3 - 0.5);
  out.mX[11] = (sint32)(X_idx_17 - 0.8 <= U_idx_4 - 0.5);
  out.mX[12] = (sint32)(Three_phase_inverter_IGBT_CH_ideal_switch_v - 0.8 <=
    U_idx_5 - 0.5);
  out.mX[13] = (sint32)(X_idx_18 - 0.8 <= U_idx_6 - 0.5);
  out.mX[14] = (sint32)(((((((X_idx_7 * -0.001 + X_idx_8 * 0.001) + X_idx_9 *
    -0.001) + X_idx_10 * 0.001) + X_idx_11 * -0.001) + X_idx_12 * 0.001) +
    X_idx_16) + -110.0 > 0.8);
  out.mX[15] = (sint32)t4;
  out.mX[16] = (sint32)(-X_idx_16 > 0.8);
  out.mX[17] = (sint32)t5;
  (void)sys;
  (void)t8;
  return 0;
